...
<div class="tab-content pt-2 pl-1" id="pills-tabContent">
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
    <img src="img/account.jpg" width="200" height="200" class="rounded" alt="..."><hr>
    <div class="">

     <div class=""><p><b style="font-size: 1.1em">Full Name :</b> BSIS - NS - 3AB</p></div>
     <div class=""><p><b style="font-size: 1.1em">Position :</b> BSIS Students</p></div>

  </div>
  <hr>
  </div>
  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
   <h6 style="font-size: 1.1em">Document Repository Management (DRM)</h6><Hr>
     is a system that aims to assist the school admins in
   processing, keeping, and publicizing documents for the students to see in a much more
   efficient, timely, and structured manner. The processing of documents will be done
   digitally, and the documents will be obtained online by downloading the uploaded file
   respectively. Both the admins and the students can benefit from this project as the
   documents can only be accessed by the authorized parties – ensuring the security and
   access control of the system.</div>
  <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab"><h6 style="font-size: 1.1em">Contact Number</h6><Hr><br><div class=""><p><b style="font-size: 1.1em">Cellphone #:</b>09000000000</p></div><p><b style="font-size: 1.1em">Address :</b> Philippines</p>
</div><hr><br>
<!--   <div class="card">
...
<div class="card" style="border-top: 4px solid #17a2b8;border-radius: 4px;">
  ...
  <div class="card-body">
    ...
    <ul>
      <li> <p>Improve the transaction and the working environment of the employees.</p></li>
      <li> <p>Ease the labor work of the employees.</p></li>
      <li> <p>Fast and efficient systems.</p></li>
    </ul>
    <!-- Button -->
